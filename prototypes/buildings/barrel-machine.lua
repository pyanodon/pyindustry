...
ENTITY {
    ...
    fluid_boxes = {
        --1
        {
            ...
            volume = 1000,
            base_level = -1,
            pipe_connections = {{flow_direction = "input", position = {-1.0, -1.3}, direction = defines.direction.north}}
        },
        {
            ...
            volume = 1000,
            volume = 100,
            pipe_connections = {{flow_direction = "output", position = {1.0, 1.3}, direction = defines.direction.south}}
        },

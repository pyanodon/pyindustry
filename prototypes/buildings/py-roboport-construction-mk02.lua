...
ENTITY({
    ...
    base_animation = {
        layers = {
            {
                filename = "__pyindustrygraphics__/graphics/entity/py-zone-extender-mk02/r.png",
                priority = "extra-high",
                width = 192,
                height = 320,
                line_length = 10,
            ...
            {
                filename = "__pyindustrygraphics__/graphics/entity/py-zone-extender-mk02/ao.png",
                priority = "extra-high",
                width = 192,
                height = 320,
                line_length = 10,
            ...
            {
                filename = "__pyindustrygraphics__/graphics/entity/py-zone-extender-mk02/sh.png",
                priority = "extra-high",
                width = 192,
                height = 160,
                line_length = 10,

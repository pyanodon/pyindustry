...
local colors = {
  { name = 'red'    , player_color = { r = 0.815, g = 0.024, b = 0.0  , a = 0.5 }, chat_color = { r = 1.000, g = 0.266, b = 0.241 }, dye = {type = 'fluid', name = 'blood', amount = 5} },
  ...
  { name = 'pink'   , player_color = { r = 0.929, g = 0.386, b = 0.514, a = 0.5 }, chat_color = { r = 1.000, g = 0.720, b = 0.833 }, dye = {type = 'item', name = 'cobalt-fluoride', amount = 1} },
  ...
  { name = 'cyan'   , player_color = { r = 0.275, g = 0.755, b = 0.712, a = 0.5 }, chat_color = { r = 0.335, g = 0.918, b = 0.866 }, dye = {type = 'fluid', name = 'cyanic-acid', amount = 5} },
  { name = 'acid'   , player_color = { r = 0.559, g = 0.761, b = 0.157, a = 0.5 }, chat_color = { r = 0.708, g = 0.996, b = 0.134 }, dye = {type = 'fluid', name = 'acetic-acid', amount = 5} }
}

...
local colors = {
  { name = 'red'    , player_color = { r = 0.815, g = 0.024, b = 0.0  , a = 0.5 }, chat_color = { r = 1.000, g = 0.266, b = 0.241 }, dye = {type = 'fluid', name = 'blood', amount = 10} },
  ...
  { name = 'purple' , player_color = { r = 0.485, g = 0.111, b = 0.659, a = 0.5 }, chat_color = { r = 0.821, g = 0.440, b = 0.998 }, dye = {type = 'fluid', name = 'vpulp3', amount = 10} },

...
TECHNOLOGY('construction-robotics'):remove_prereq('advanced-electronics'):remove_prereq('robotics'):add_prereq('engine'):remove_pack('chemical-science-pack'):remove_pack('logistic-science-pack')
